...
| `ESC-16` | Observación: «contradice la decisión vigente de SaaS multi-tenant» | `DEC-01` está derogada | [:OK:] **Hecho el 8-sep-2026.** La observación del libro se reescribió: el modelo multi-tenant se descartó y hoy manda `ADR-001`, que es justo lo que este escenario pide |
